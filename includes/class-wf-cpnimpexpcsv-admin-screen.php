...
class WF_CpnImpExpCsv_Admin_Screen {
    ...
    {
		$page = add_submenu_page( 'wf_woocommerce_order_im_ex', __( 'Coupon Im-Ex', 'order-import-export-for-woocommerce' ), __( 'Coupon Im-Ex', 'order-import-export-for-woocommerce' ), apply_filters( 'coupon_csv_coupon_role', 'manage_woocommerce' ), 'wf_coupon_csv_im_ex', array( $this, 'output' ) );
	}
